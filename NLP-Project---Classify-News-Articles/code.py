...
log_reg_1 = OneVsRestClassifier(LogisticRegression(random_state = 10))
log_reg_2 = OneVsRestClassifier(LogisticRegression(random_state = 10))
...
# fit on tfidf vectorizer training data
log_reg_2.fit(X_train_tfidf, y_train)


# accuracy with count vectorizer
acc_count_logreg = accuracy_score(log_reg_1.predict(X_test_count), y_test)

# accuracy with tfidf vectorizer
acc_tfidf_logreg = accuracy_score(log_reg_2.predict(X_test_tfidf), y_test)
