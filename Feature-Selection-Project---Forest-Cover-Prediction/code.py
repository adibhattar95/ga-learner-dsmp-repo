...
#Correlation between first 10 features
data_corr = subset_train.corr()

#Heatmap of data_corr
...
#Slicing values from correlation
...
#Initialize one ve rest classifier
